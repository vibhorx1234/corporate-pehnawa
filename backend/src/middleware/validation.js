// File: ./backend/src/middleware/validation.js  (MODIFIED)
// Changes: Added validateRegister and validateLogin at the bottom.
// All original validators are unchanged.
...
exports.validateOrder = [
  ...
  body('sizeType').isIn(['standard', 'custom']).withMessage('Invalid size type'),
  body('standardSize')
...
exports.validateLogin = [
  body('email').if((value, { req }) => !req.body.phone)
    .notEmpty().withMessage('Email is required')
    .isEmail().withMessage('Invalid email address'),

  body('phone').if((value, { req }) => !req.body.email)
    .notEmpty().withMessage('Phone number is required')
